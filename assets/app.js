...
let spinBtn = document.querySelector(".spin-button");
let min = 0;
let max = 0;
...
spinBtn.addEventListener("click", () => {
  if (min === 0 || max === 0 || max < min) {
    ...
    numberSpin("scroll1").stop(5000, Math.floor(winner / 10000));
    numberSpin("scroll2").stop(6000, Math.floor((winner % 10000) / 1000));
    numberSpin("scroll3").stop(7000, Math.floor((winner % 1000) / 100));
    numberSpin("scroll4").stop(8000, Math.floor((winner % 100) / 10));
    numberSpin("scroll5").stop(9000, winner % 10);
